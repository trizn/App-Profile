...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "TriZN_Profile")
    ...
    // Add quick action 3d touch
    func addShortcuts(application: UIApplication) {
        let shortcut1 = UIMutableApplicationShortcutItem.init(type: "Contact",
                                                              localizedTitle: "Hello!",
                                                              localizedSubtitle: "I'm Vo Tri",
                                                              icon: UIApplicationShortcutIcon.init(type: .contact),
                                                              userInfo: nil)
        let shortcut2 = UIMutableApplicationShortcutItem.init(type: "Swift!",
                                                              localizedTitle: "Swift",
                                                              localizedSubtitle: "My Skills",
                                                              icon: UIApplicationShortcutIcon.init(type: .compose),
                                                              userInfo: nil)
